...
if(NOT CMAKE_D_CREATE_SHARED_LIBRARY)
  set(CMAKE_D_CREATE_SHARED_LIBRARY
    "<CMAKE_D_COMPILER> <CMAKE_SHARED_LIBRARY_D_FLAGS> <LANGUAGE_COMPILE_FLAGS> <LINK_FLAGS> <CMAKE_SHARED_LIBRARY_CREATE_D_FLAGS> <SONAME_FLAG><TARGET_SONAME> ${CMAKE_D_OUTPUT_FLAG}<TARGET> <OBJECTS> <LINK_LIBRARIES>")
endif()
...
if(NOT DEFINED CMAKE_D_CREATE_STATIC_LIBRARY)
  set(CMAKE_D_CREATE_STATIC_LIBRARY "${CMAKE_D_COMPILER} -lib ${CMAKE_D_OUTPUT_FLAG}<TARGET> <LINK_FLAGS> <OBJECTS>")
endif()
...
if(NOT CMAKE_D_COMPILE_OBJECT)
  set(CMAKE_D_COMPILE_OBJECT
    #"<CMAKE_D_COMPILER> <FLAGS> ${CMAKE_INCLUDE_FLAG_D}<CMAKE_CURRENT_SOURCE_DIR> ${CMAKE_D_OUTPUT_FLAG}<OBJECT> -c <SOURCE>")
    "<CMAKE_D_COMPILER> <FLAGS> ${CMAKE_INCLUDE_FLAG_D}<CMAKE_CURRENT_SOURCE_DIR> ${CMAKE_D_OUTPUT_FLAG}<OBJECT> -c <SOURCE>")
endif()

if(NOT CMAKE_D_LINK_EXECUTABLE)
  set(CMAKE_D_LINK_EXECUTABLE
    #"<CMAKE_D_COMPILER> <FLAGS> ${CMAKE_INCLUDE_FLAG_D}<CMAKE_CURRENT_SOURCE_DIR> <CMAKE_D_LINK_FLAGS> <LINK_FLAGS> <OBJECTS> ${CMAKE_D_OUTPUT_FLAG}<TARGET> <LINK_LIBRARIES>")
    "<CMAKE_D_COMPILER> <FLAGS> <CMAKE_D_LINK_FLAGS> <LINK_FLAGS> <OBJECTS> ${CMAKE_D_OUTPUT_FLAG}<TARGET> <LINK_LIBRARIES>")
endif()
